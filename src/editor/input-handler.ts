...
import type { FunctionRunner } from '../services/function-runner';
import {
...
export class InputHandler {
  ...
  private functionRunner: FunctionRunner | null;
  ...
  constructor(
    ...
    compileManager?: CompileManager | null,
    functionRunner?: FunctionRunner | null,
  ) {
  ...
  private parse(raw: string): ParsedEvent | null {
    ...
    if (raw.startsWith('runFunction\u00B6')) {
      ...
      if (!uniqueId || !fileName) return null;
